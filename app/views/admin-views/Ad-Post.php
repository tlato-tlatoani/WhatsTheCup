...
<head>
  ...
  <link rel="stylesheet" href="/WhatsTheCup/public/css/Ad_Post.css">
...
<div id="layout">
  ...
  <div class="comentario-contenido">
       <div class="eliminar"> 
        <h3>Usuario X</h3>
       <button button id="btn-eliminar"> <i class="bi bi-x"></i> </button> 
    </div>
...
<div class="comentario">
  ...
  <div class="comentario-contenido">
    ...
    <div class="eliminar"> 
        <h3>Usuario X</h3>
       <button id="btn-eliminar"> <i class="bi bi-x"></i> </button> 
    </div>
...
<script src="/WhatsTheCup/public/js/Ad_Post.js"></script>
